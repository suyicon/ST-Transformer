...
from model.gatten import GraphMultiHeadAttention
from model.gcn import GCN
from model.gat_layer import GAT
...
class SpatialTransformer(nn.Module):
    def __init__(self, d_k, d_v, d_model, len_his, n_heads, n_nodes, dropout, adj=None):
        ...
        self.gat = GAT(d_model, d_model, d_model * 4, dropout)

        self.atten = GraphMultiHeadAttention(d_k, d_v, d_model, n_heads, dropout)
